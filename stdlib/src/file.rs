...
impl StdlibRegistry {
    pub fn register_file(&mut self) {
        ...
        exports.insert("read".to_string(), Rc::new(StdFunction {
            name: "read".to_string(),
            arity: 1,
            callback: |_ctx, args| {
        ...
        exports.insert("write".to_string(), Rc::new(StdFunction {
        ...
        exports.insert("copy".to_string(), Rc::new(StdFunction {
            name: "copy".to_string(),
            arity: 2,
            callback: |_ctx, args| {
        ...
        exports.insert("exists".to_string(), Rc::new(StdFunction {
        ...
        self.register_module("std.file", StdlibModule {
