...
### 🚀 Getting Started
* [Installation](Installation.md) - Set up TechScript on Windows, Linux, macOS, or Build from Source.
* [Language Guide](LanguageGuide.md) - Learn variables, loops, conditionals, and functions.
* [Syntax Guide](SyntaxGuide.md) - Quick reference on keywords, precedence, and layout rules.
* [Best Practices](BestPractices.md) - Coding standards, constants, and safety.
...
* [Examples Guide](ExamplesGuide.md) - Running and checking code examples.
