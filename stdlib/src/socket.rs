...
impl StdlibRegistry {
    pub fn register_socket(&mut self) {
        ...
        exports.insert("connect".to_string(), Rc::new(StdFunction {
            ...
            callback: |_ctx, args| {
                ...
                let port = match &args[1] {
                    ...
                    _ => return Err(RuntimeError::new(
                        techscript_runtime::error::RuntimeErrorKind::TypeMismatch { expected: "int".to_string(), found: "other".to_string() },
                        None, None,
                    )),
                };
        ...
        exports.insert("listen".to_string(), Rc::new(StdFunction {
        ...
        self.register_module("std.socket", StdlibModule {
