...
fn register_list_functions(
    exports: &mut HashMap<String, Rc<dyn techscript_runtime::function::Callable>>,
) {
    exports.insert(
        "push".to_string(),
        Rc::new(StdFunction {
...
impl StdlibRegistry {
    pub fn register_collections(&mut self) {
        ...
        register_list_functions(&mut exports);
        register_common_functions(&mut exports);
        register_map_functions(&mut exports);
